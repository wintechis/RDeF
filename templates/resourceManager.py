...
class ResourceManager:
    ...
    def get_resource_path(chapter_path: str, file_name: str) -> str:
        ...
        if any(map(file_name.endswith, allowed_ext)): 
            file_path = ResourceManager._search_resource_folder(story_resource_dir, main_resource_path, file_name)
        else:
            file_path = ResourceManager._search_resource_with_ext(story_resource_dir, main_resource_path, file_name, allowed_ext)
    ...
    @staticmethod
    def _search_resource_folder(story_resource_dir, main_resource_path, file_name) -> str:
    ...
    @staticmethod
    def _search_resource_with_ext(story_resource_dir, main_resource_path, file_name, exts) -> str:
        for ext in exts:
            file_path = ResourceManager._search_resource_folder(story_resource_dir, main_resource_path, file_name + ext)
            if file_path: break
        return file_path
